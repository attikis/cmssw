...
L1TkEGTaus = cms.EDProducer("L1TkEGParticleProducer",
        label = cms.string("TkEG"), 	# labels the collection of L1TkEGParticleProducer that is produced
...
#L1TkEGsTightIsol = L1TkPhotons.clone()
#L1TkEGsTightIsol.IsoCut = cms.double( 0.10)
